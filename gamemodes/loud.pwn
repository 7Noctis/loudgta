...
{
	ShowPlayerDialog(playerid, DIALOG_SPAWNS, DIALOG_STYLE_LIST, "����� ������", "\
		��� ������\n\
		��� ������\n\
		��� ��������\n\
		���", "��", "�� ��");
...
CMD:stats(playerid, params[])
{
	...
	format(str, sizeof(str), "\
		...
		������: %d\n\
		������: %d\n\
		����: %d", pInfo[playerid][pID], pInfo[playerid][pAdminLevel], pInfo[playerid][pKills], pInfo[playerid][pDeaths], pInfo[playerid][pMoney], pInfo[playerid][pExp]);

	ShowPlayerDialog(playerid, DIALOG_PLAYER_STATS, DIALOG_STYLE_MSGBOX, "����������", str, "��", "������");
	return 1;
}
...
public OnPlayerKeyStateChange(playerid, newkeys, oldkeys)
{
	if(newkeys == KEY_YES)
	{
		ShowPlayerDialog(playerid, DIALOG_PLAYER_MENU, DIALOG_STYLE_LIST, "����", "\
			���������\n\
			���������", "��", "�� ��");
	}
	...
	if(newkeys == KEY_WALK)
	{
		...
		{
			ShowPlayerDialog(playerid, DIALOG_ORG_CREATE, DIALOG_STYLE_LIST, "������", "�������", "��", "�� ��");
		}
	}
	return 1;
}
...
public OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
	switch(dialogid)
	{
		case DIALOG_ORG_CREATE:
		{
			...
			if(listitem == 0)
			{
				ShowPlayerDialog(playerid, DIALOG_ORG_NAME, DIALOG_STYLE_INPUT, "��������", "������������ ����", "��", "�� ��");
			}
		}
		...
		case DIALOG_ORG_NAME:
		{
			...
			if(!strlen(inputtext)) return ShowPlayerDialog(playerid, DIALOG_ORG_NAME, DIALOG_STYLE_MSGBOX, "��������", "������������ ����", "��", "�� ��");
			if(strlen(inputtext) < 3 || strlen(inputtext) > 96) return ShowPlayerDialog(playerid, DIALOG_ORG_NAME, DIALOG_STYLE_INPUT, "��������", "������������ ����", "��", "�� ��");
			...
			for(new i; i < strlen(inputtext); i++)
			{
				switch(inputtext[i])
				{
					...
					default: return ShowPlayerDialog(playerid, DIALOG_ORG_NAME, DIALOG_STYLE_MSGBOX, "��������", "������������ ����", "��", "�� ��");
				}
			}
		...
		case DIALOG_PLAYER_MENU:
		{
			...
			if(listitem == 0)
			{
				ShowPlayerDialog(playerid, DIALOG_PLAYER_CARS, DIALOG_STYLE_LIST, "���������", "\
					��������� �����\n\
					������ ID\n\
					��������\n\
					������\n\
			...
			if(listitem == 1)
			{
				ShowPlayerDialog(playerid, DIALOG_TELEPORTS, DIALOG_STYLE_LIST, "���������", "\
					> ��� ������\n\
					���� �����\n\
					����\n\
					��������\n\
		...
		case DIALOG_TELEPORTS:
		{
			...
			if(listitem == 2) SetPlayerPos(playerid, 2761.4063,-2393.4446,13.6328); // ����
			if(listitem == 3) SetPlayerPos(playerid, 1683.4183,-2244.7646,13.5431); // ��������
			if(listitem == 4) SetPlayerPos(playerid, 848.9660,-2009.4229,12.8672); // ����
			if(listitem == 5) SetPlayerPos(playerid, 378.6031,-2037.5452,7.8301); // ������
			if(listitem == 6) SetPlayerPos(playerid, 678.4388,-1260.7935,13.6013); // �����
			if(listitem == 7) SetPlayerPos(playerid, 1478.1797,-743.5845,92.9847); // �������
			if(listitem == 8) SetPlayerPos(playerid, 1509.0387,-1328.3885,14.0271);// �����
			if(listitem == 9) SetPlayerPos(playerid, 1475.8754,-1722.3700,13.5469); // �����
			if(listitem == 10) SetPlayerPos(playerid, 1876.8812,-1377.4958,13.5618); // ���������
			if(listitem == 11) SetPlayerPos(playerid, 2206.8823,-1159.6573,25.7287); // ��������������
			if(listitem == 12) SetPlayerPos(playerid, 1765.5928,-1900.4380,13.5649); // �����������
			if(listitem == 13) SetPlayerPos(playerid, 1154.7061,-2012.7147,69.0078); // �������������
		...
		case DIALOG_PLAYER_CARS:
		{
			...
			if(listitem == 1)
			{
				ShowPlayerDialog(playerid, DIALOG_PLAYER_CARID, DIALOG_STYLE_INPUT, "������� ID", "\
					����� �� ���� �����", "��", "�� ��");
			}
		...
		case DIALOG_BUSINESS_MANAGE:
		{
			...
			{
				new str[28 - 2 + 11];
				format(str, sizeof(str), "������ ������ ���������: %d", bInfo[pInfo[playerid][pHouseID]][bBudget]);
		...
		case  DIALOG_BUSINESS_BUY:
		{
			...
			if(listitem == 0)
			{
				if(GetPlayerMoney(playerid) < 70) return SendClientMessage(playerid, -1, "� ��� ��� ����� �����.");
			...
			if(listitem == 1)
			{
				if(GetPlayerMoney(playerid) < 120) return SendClientMessage(playerid, -1, "� ��� ��� ����� �����.");
			...
			if(listitem == 2)
			{
				if(GetPlayerMoney(playerid) < 180) return SendClientMessage(playerid, -1, "� ��� ��� ����� �����.");
		...
		case DIALOG_BUSINESS_ENTER:
		{
			...
			if(listitem == 1)
			{
				...
				ShowPlayerDialog(playerid, DIALOG_BUSINESS_INFO, DIALOG_STYLE_MSGBOX, bInfo[pInfo[playerid][pHouseID]][bName], str, "��", "�����");
			}
			if(listitem == 2)
			{
				if(!strcmp(bInfo[pInfo[playerid][pHouseID]][bOwner], "-"))
				{
					if(GetPlayerMoney(playerid) < bInfo[pInfo[playerid][pHouseID]][bPrice]) return SendClientMessage(playerid, -1, "� ��� ������������ ������� ��� ������� ������� �������.");
					ShowPlayerDialog(playerid, DIALOG_BUSINESS_GET, DIALOG_STYLE_MSGBOX, "������� �������", "�� �������, ��� ������ ���������� ������ ������?", "����������", "�����");
				}
				else
				{
					SendClientMessage(playerid, -1, "��������, �� � ����� ��������� ��� ���� ��������.");
		...
		{
			if(!response) return ShowPlayerDialog(playerid, DIALOG_BUSINESS_ENTER, DIALOG_STYLE_LIST, bInfo[pInfo[playerid][pHouseID]][bName], "�����\n���������� ���������� � �������\n����������", "�������", "�����");
		}
		...
		case DIALOG_REGISTER:
		{
			...
			if(strlen(inputtext) < 4 || strlen(inputtext) > 28) return ShowPlayerDialog(playerid, DIALOG_REGISTER, DIALOG_STYLE_INPUT, "������� ������", "������ ������", "����������", "�����");
			...
			for(new i; i < strlen(inputtext); i++)
			{
				...
				{
					case 'A'..'Z', 'a'..'z', '0'..'9': continue;
					default: return ShowPlayerDialog(playerid, DIALOG_REGISTER, DIALOG_STYLE_INPUT, "������� ������", "������ ������", "����������", "�����");
				}
			}
		...
		case DIALOG_LOGIN:
		{
			...
			if(!strlen(inputtext)) return ShowPlayerDialog(playerid, DIALOG_LOGIN, DIALOG_STYLE_INPUT, "������� ������", "������ ������ ��� �����������", "����������", "�����");
			if(strlen(inputtext) < 4 || strlen(inputtext) > 28) return ShowPlayerDialog(playerid, DIALOG_LOGIN, DIALOG_STYLE_INPUT, "������� ������", "������ ������ ��� �����������", "����������", "�����");
			...
			for(new i; i < strlen(inputtext); i++)
			{
				...
				{
					case 'A'..'Z', 'a'..'z', '0'..'9': continue;
					default: return ShowPlayerDialog(playerid, DIALOG_LOGIN, DIALOG_STYLE_INPUT, "������� ������", "������ ������ ��� �����������", "����������", "�����");
				}
			}
